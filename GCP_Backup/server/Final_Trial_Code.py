                ...
                if prefix == 'prompt':
                    ...
                    if chosen_response:
                        ...
                        if conversation_history and conversation_history[-1][1] is None:
                            ...
                            append_to_csv_file(csv_file_path, (len(conversation_history), timestamp, conversation_history[-1][0], full_conversation_history[-1][1], chosen_response, conversation_history[-4:-1], full_conversation_history[-1][4], full_conversation_history[-1][5], server_to_pi_latency, pi_processing_latency, pi_to_server_latency, api_latency, chosen_response_latency))
                        else:
